      ...
      profiles = {
        ...
        lyse-vpn = {
          ...
          ipv4 = {
            ...
            dns-search = "lysetele.net;lysetele.io;lysetele.at;lysetele.dev;aibservers.local;altibox.ad;lyse.no;datadammen.no;datadammentest.no;sap.local;in-addr.arpa;ip6.arpa;lyse.mgmt;altibox.net;snartibox.no;snartibox.net;altibox.no;altibox.cloud;";
          };
          ipv6 = {
